...
#SBATCH --array=0-4
#SBATCH --output=logs/log-predict-cls-iss-48h-test-%a-%A.out
...
--trainer.logger.name "predict-cls-iss-48h" \
--trainer.logger.version "predict-cls-iss-48h-test-$TEST_SPLIT" \
--ckpt_path "runs/cls-iss-48h/cls-iss-48h-test-$TEST_SPLIT.ckpt"
