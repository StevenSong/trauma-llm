...
#SBATCH --array=0-4
#SBATCH --output=logs/log-predict-cls-mort-48h-test-%a-%A.out
...
--trainer.logger.name "predict-cls-mort-48h" \
--trainer.logger.version "predict-cls-mort-48h-test-$TEST_SPLIT" \
--ckpt_path "runs/cls-mort-48h/cls-mort-48h-test-$TEST_SPLIT.ckpt"
